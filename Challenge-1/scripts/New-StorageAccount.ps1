...
Deploy Storage Account to any of the 3 tier enviornment - DEV, TEST, PROD

.DESCRIPTION

Code is used to deploy Storage Account (SA) in Azure Infrastructure.
Deployable resources can be deployed in either DEV, TST or PRD Cloud Core subscriptions, based on parameter input on the Pipeline.
